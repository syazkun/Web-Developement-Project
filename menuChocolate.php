...
<head> 
  ...
  <title>Order | Heavenly Chocolate Cake</title> 
    ...
    <form action="" method="POST">
      <div class="table"> 
        <div class="left-column"> 
          <img data-image="black" src="./Assets/choc-cake.jpg" alt=""> 
        </div> 
        <?php 
        $connection = mysqli_connect("localhost", "root", "", "adminpanel"); 
        $query = "SELECT * FROM managecake WHERE id = '1'"; 
        ...
        ?> 
            ...
            <div class="right-column"> 
              ...
              <div class="product-description"> 
                ...
                <p>This cake is simply 'out of this world'! Upon first glance, you already know it is going to be a jaw
            dropper, and then when you take a look at what exactly this cake is made up of, you will know just why this
            is called a Heavenly Chocolate Cake.</p> 
...
$connection = mysqli_connect("localhost", "root", "", "adminpanel"); 
$query = "SELECT * FROM managecake WHERE id='2'"; 
$query_run = mysqli_query($connection, $query); 
...
$connection = mysqli_connect("localhost", "root", "", "adminpanel"); 
$query = "SELECT * FROM managecake WHERE id='3'"; 
$query_run = mysqli_query($connection, $query); 
