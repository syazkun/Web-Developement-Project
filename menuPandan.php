    ...
    <form action="" method="POST">
      <div class="table"> 
        <div class="left-column"> 
          <img data-image="black" src="./Assets/pandan.jpg" alt=""> 
        </div> 
        <?php 
        $connection = mysqli_connect("localhost", "root", "", "adminpanel"); 
        $query = "SELECT * FROM managecake WHERE id = '7'"; 
        ...
        ?> 
            ...
            <div class="right-column"> 
              ...
              <div class="product-description"> 
                ...
                <p>The Locale Cake is a moist pandan cake generously infused with fresh pandan juice and coconut extract.
            Frosted with our signature gula Melaka buttercream with a layer of homemade gula Melaka sauce and coconut
            shavings</p> 
...
$connection = mysqli_connect("localhost", "root", "", "adminpanel"); 
$query = "SELECT * FROM managecake WHERE id='8'"; 
$query_run = mysqli_query($connection, $query); 
...
$connection = mysqli_connect("localhost", "root", "", "adminpanel"); 
$query = "SELECT * FROM managecake WHERE id='9'"; 
$query_run = mysqli_query($connection, $query); 
